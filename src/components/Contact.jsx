...
const Contact = () => {
    ...
    return (
        <motion.div initial={{opacity: 0, x:-200}} transition={{duration: 1}} whileInView={{opacity: 1, x:0}} viewport={{once: true}} className="text-center p-6 py-20 lg:px-32 w-full overflow-hidden min-h-screen flex flex-col justify-center" id="Contact">
            ...
            <p className="text-center text-gray-500 mb-12 max-w-80 mx-auto">Let’s turn your <span className="text-orange-500">Dream Home</span> into a real address.</p>
            ...
            <form onSubmit={onSubmit} className="max-w-2xl mx-auto text-gray-600 pt-8">
                ...
                <button className="bg-blue-600 text-white py-2 px-12 mb-10 rounded cursor-pointer active:scale-95 transition-all delay-75">{result ? result : "Send Message"}</button>
