...
const About = () => {
    return(
        <div className="flex flex-col items-center justify-center container mx-auto p-14 md:px-20 lg:px-32 w-full overflow-hidden" id="About">
            <h1 className="text-2xl sm:text-4xl font-bold mb-2">About <span className='underline underline-offset-4 decoration-1 under font-light'>Luminos</span></h1>
            <p className="text-gray-500 max-w-100 text-center mb-8 mt-2 text-sm leading-normal">At Luminos Real Estate, we believe that finding a home is more than just a transaction—it's a journey toward a brighter future. Our mission is to guide you through that journey with clarity, trust, and a personal touch. Whether you're buying your first home, upgrading to match your lifestyle, or investing for tomorrow, our experienced team is dedicated to helping you navigate the market with confidence. With a passion for modern living and a deep understanding of what makes a house feel like home, Luminos is here to bring your vision to life.</p>
            <div className="flex flex-col md:flex justify-center items-center my-10 md:gap-20 lg:flex-row lg:items-start">
                ...
                <div className="flex flex-col items-center md:items-start mt-5 text-gray-600 lg:mt-10">
                    ...
                    <p className="my-15 max-w-xl w-120 text-center md:my-7 lg:text-left">At Luminos, we combine local expertise with cutting-edge technology to deliver smart, sustainable spaces tailored to your lifestyle. Our client-first approach has earned us a reputation for reliability, transparency, and exceptional results. Every project we take on reflects our commitment to quality, innovation, and creating lasting value for homeowners and investors alike.</p>
